...
def main():
    ...
    demo_vid_paths={
        "video 1":'demo_vid_2.mp4',
        "video 2":'demo_vid_1.mp4'
    }
    demo_vid_path = demo_vid_paths[demo_selected]
    demo_team_info = {
        "video 1":{"team1_name":"France",
    ...
    with tab3:
        ...
        with bcol2:
            ...
            with bcol21t:
                ...
                show_p = st.toggle(label="Show Players Detections", value=False)
            with bcol22t:
                show_pal = st.toggle(label="Show Color Palettes", value=False)
